default[:chub_orderstream_iis][:default_app_pool_config][:enable_32_bit] = "false"
default[:chub_orderstream_iis][:default_app_pool_config][:managed_runtime_version ] = "v4.0"
...
default[:chub_orderstream_iis][:orderstream_site_ip_address] = "*"
...
default[:chub_orderstream_iis][:orderstream_site_binding][:certificate_name]  = "*.nexus.commercehub.com"