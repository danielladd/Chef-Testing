...
## mc_platform Handler
sensu_handler "mc_platform_team" do
    type "set"
...
# Checks
sensu_check "mc_platform_check_disk" do
    command "/usr/bin/ruby1.9.3 #{node[:chub_sensu][:root_plugin_path]}/check-disk.rb"
    handlers ["mc_platform_team"]
    subscribers ["mc_platform_team"]
    interval 60
end

sensu_check "mc_platform_check_cpu" do
...
sensu_check "mc_platform_check_ram" do
