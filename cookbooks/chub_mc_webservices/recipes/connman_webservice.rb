...
group "chub_connman_webservice" do
    action :create
    system true
end

user "chub_connman_webservice" do
    comment "Application user for connman_webservice"
    gid "chub_connman_webservice"
    system true
end
...
group "chub_connman_webservice" do
    action :modify
    append true
    members ["chub_connman_webservice", "chadmin"]
end
