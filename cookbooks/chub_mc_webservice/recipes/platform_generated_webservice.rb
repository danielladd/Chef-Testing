...
# Recipe:: platform_generated_webservice
#
...
node.normal[:chub_mc_webservice][:serviceName] = "OVERRIDE_ME"
node.normal[:chub_mc_webservice][:webservice] = "#{node[:chub_mc_webservice][:serviceName]}-webservice"
...
node.normal[:chub_mc_webservice][:webservice_name] = "#{node[:chub_mc_webservice][:serviceName]}_webservice"
