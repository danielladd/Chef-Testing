...
default['chub-missioncontrol']['app']['bamboo_server_artifact_name'] = 'bootstrap.war'
...
default['chub-missioncontrol']['webservice']['bamboo_server_artifact_name'] = 'inventory-web-service-demo-standalone.jar'