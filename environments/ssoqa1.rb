...
default_attributes(
  ...
  "chub_sensu_sso" => {
    ...
    "loadbalancer_urls" => {
      "vault" => "https://ssoqa1-vault.nexus.commercehub.com:8443/info",
      "census" => "https://ssoqa1-census.nexus.commercehub.com:8443/info",
  ...
  "chub-vault" => {
    ...
    "ldap_write_host" => "ssoqa1-ldap-write.nexus.commercehub.com",
    "database" => {
